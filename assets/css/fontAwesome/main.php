...
<body style="background-color:#585b5b">
    ...
    $(".item").draggable({
        ...
        console.log(this.id);
        //$("div#stop").text("STOP: \nLeft: "+ pos.left + "\nTop: " + pos.top);
        //console.log(this.id+"-"+pos.left+","+pos.top);
        // $.get("./?action=updpos&id="+this.id+"&left="+pos.left+"&top="+pos.top,function(data){
        //     console.log(data);
        // });
        }
    ...
    $(".item").click(function(){
//        alert(this.id);
        // $.get("./?action=getmonitor","item_id="+this.id.split('-')[1],function(data){
        //     $("#data").html(data);
        // });
    });
</script>
